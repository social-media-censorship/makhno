...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MakhnoApiDesign.GAFAMApi();
  });

  describe('(package)', function() {
    describe('GAFAMApi', function() {
      describe('gAFAMparse', function() {
        it('should call gAFAMparse successfully', function(done) {
          // TODO: uncomment, update parameter values for gAFAMparse call and complete the assertions
          /*

          instance.gAFAMparse(body, targetURL, source, countryCode, html, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MakhnoApiDesign.ParseResult);
      ...
      describe('gAFAMsupported', function() {
        it('should call gAFAMsupported successfully', function(done) {
          // TODO: uncomment, update parameter values for gAFAMsupported call and complete the assertions
          /*
          var opts = {};

          instance.gAFAMsupported(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MakhnoApiDesign.SupportedUrl);
      ...
      describe('gAFAMsupportedList', function() {
        it('should call gAFAMsupportedList successfully', function(done) {
          // TODO: uncomment gAFAMsupportedList call and complete the assertions
          /*

          instance.gAFAMsupportedList(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MakhnoApiDesign.SupportedUrlFormatList);
