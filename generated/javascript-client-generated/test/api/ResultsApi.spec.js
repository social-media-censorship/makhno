...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MakhnoApiDesign.ResultsApi();
  });

  describe('(package)', function() {
    describe('ResultsApi', function() {
      describe('retrieveResults', function() {
        it('should call retrieveResults successfully', function(done) {
          // TODO: uncomment, update parameter values for retrieveResults call and complete the assertions
          /*
          var opts = {};

          instance.retrieveResults(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MakhnoApiDesign.TestResultList);
      ...
      describe('submitValidationCheck', function() {
        it('should call submitValidationCheck successfully', function(done) {
          // TODO: uncomment, update parameter values for submitValidationCheck call
          /*

          instance.submitValidationCheck(body, submissionId, testId, vantagePoint, checkTimeUTC, status, authoritative, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
