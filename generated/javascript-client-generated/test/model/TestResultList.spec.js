...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TestResultList', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.TestResultList();
      });

      it('should create an instance of TestResultList', function() {
        // TODO: update the code to test TestResultList
        expect(instance).to.be.a(MakhnoApiDesign.TestResultList);
      });
