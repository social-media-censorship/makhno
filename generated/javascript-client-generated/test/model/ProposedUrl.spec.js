...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProposedUrl', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.ProposedUrl();
      });

      it('should create an instance of ProposedUrl', function() {
        // TODO: update the code to test ProposedUrl
        expect(instance).to.be.a(MakhnoApiDesign.ProposedUrl);
      });
