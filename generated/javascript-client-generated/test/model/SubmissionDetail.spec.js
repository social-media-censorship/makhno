...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubmissionDetail', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SubmissionDetail();
      });

      it('should create an instance of SubmissionDetail', function() {
        // TODO: update the code to test SubmissionDetail
        expect(instance).to.be.a(MakhnoApiDesign.SubmissionDetail);
      });
