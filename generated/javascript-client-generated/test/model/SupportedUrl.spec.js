...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SupportedUrl', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SupportedUrl();
      });

      it('should create an instance of SupportedUrl', function() {
        // TODO: update the code to test SupportedUrl
        expect(instance).to.be.a(MakhnoApiDesign.SupportedUrl);
      });
      ...
      it('should have the property supported (base name: "supported")', function() {
        // TODO: update the code to test the property supported
        expect(instance).to.have.property('supported');
        // expect(instance.supported).to.be(expectedValueLiteral);
      });
