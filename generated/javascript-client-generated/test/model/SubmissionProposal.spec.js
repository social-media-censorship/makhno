...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubmissionProposal', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SubmissionProposal();
      });

      it('should create an instance of SubmissionProposal', function() {
        // TODO: update the code to test SubmissionProposal
        expect(instance).to.be.a(MakhnoApiDesign.SubmissionProposal);
      });
