...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidityCheck', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.ValidityCheck();
      });

      it('should create an instance of ValidityCheck', function() {
        // TODO: update the code to test ValidityCheck
        expect(instance).to.be.a(MakhnoApiDesign.ValidityCheck);
      });
