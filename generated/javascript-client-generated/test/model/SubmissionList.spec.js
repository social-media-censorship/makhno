...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubmissionList', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SubmissionList();
      });

      it('should create an instance of SubmissionList', function() {
        // TODO: update the code to test SubmissionList
        expect(instance).to.be.a(MakhnoApiDesign.SubmissionList);
      });
