...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SupportedUrlFormatList', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SupportedUrlFormatList();
      });

      it('should create an instance of SupportedUrlFormatList', function() {
        // TODO: update the code to test SupportedUrlFormatList
        expect(instance).to.be.a(MakhnoApiDesign.SupportedUrlFormatList);
      });
