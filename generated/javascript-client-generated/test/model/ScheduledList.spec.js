...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduledList', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.ScheduledList();
      });

      it('should create an instance of ScheduledList', function() {
        // TODO: update the code to test ScheduledList
        expect(instance).to.be.a(MakhnoApiDesign.ScheduledList);
      });
