...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SupportedUrlFormat', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.SupportedUrlFormat();
      });

      it('should create an instance of SupportedUrlFormat', function() {
        // TODO: update the code to test SupportedUrlFormat
        expect(instance).to.be.a(MakhnoApiDesign.SupportedUrlFormat);
      });
