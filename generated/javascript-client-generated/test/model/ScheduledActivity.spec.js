...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduledActivity', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.ScheduledActivity();
      });

      it('should create an instance of ScheduledActivity', function() {
        // TODO: update the code to test ScheduledActivity
        expect(instance).to.be.a(MakhnoApiDesign.ScheduledActivity);
      });
      ...
      it('should have the property checkTime (base name: "checkTime")', function() {
        // TODO: update the code to test the property checkTime
        expect(instance).to.have.property('checkTime');
        // expect(instance.checkTime).to.be(expectedValueLiteral);
      });
