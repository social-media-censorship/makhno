...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TestResult', function() {
      beforeEach(function() {
        instance = new MakhnoApiDesign.TestResult();
      });

      it('should create an instance of TestResult', function() {
        // TODO: update the code to test TestResult
        expect(instance).to.be.a(MakhnoApiDesign.TestResult);
      });

      it('should have the property submission (base name: "submission")', function() {
        // TODO: update the code to test the property submission
        expect(instance).to.have.property('submission');
        // expect(instance.submission).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property vantagePoint (base name: "vantagePoint")', function() {
        // TODO: update the code to test the property vantagePoint
        expect(instance).to.have.property('vantagePoint');
        // expect(instance.vantagePoint).to.be(expectedValueLiteral);
      });

      it('should have the property checkTimeUTC (base name: "checkTimeUTC")', function() {
        // TODO: update the code to test the property checkTimeUTC
        expect(instance).to.have.property('checkTimeUTC');
        // expect(instance.checkTimeUTC).to.be(expectedValueLiteral);
      });
