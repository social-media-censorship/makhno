...
/**
 * The TestResultList model module.
 * @module model/TestResultList
 * @version 1.0.0
 */
export class TestResultList extends Array {
  /**
   * Constructs a new <code>TestResultList</code>.
   * @alias module:model/TestResultList
   * @class
   * @extends Array
   */
  constructor() {
  ...
  /**
   * Constructs a <code>TestResultList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TestResultList} obj Optional instance to populate.
   * @return {module:model/TestResultList} The populated <code>TestResultList</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new TestResultList();
      ApiClient.constructFromObject(data, obj, 'TestResult');
    }
    return obj;
  }
}
