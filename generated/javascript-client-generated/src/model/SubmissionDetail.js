...
import {SupportedUrl} from './SupportedUrl';

/**
 * The SubmissionDetail model module.
 * @module model/SubmissionDetail
 * @version 1.0.0
 */
export class SubmissionDetail {
  /**
   * Constructs a new <code>SubmissionDetail</code>.
   * @alias module:model/SubmissionDetail
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SubmissionDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SubmissionDetail} obj Optional instance to populate.
   * @return {module:model/SubmissionDetail} The populated <code>SubmissionDetail</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SubmissionDetail();
      if (data.hasOwnProperty('url'))
        obj.url = SupportedUrl.constructFromObject(data['url']);
...
/**
 * @member {module:model/SupportedUrl} url
 */
SubmissionDetail.prototype.url = undefined;

/**
 * @member {Array.<String>} countryCodes
 */
SubmissionDetail.prototype.countryCodes = undefined;
