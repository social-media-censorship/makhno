...
/**
 * The SubmissionList model module.
 * @module model/SubmissionList
 * @version 1.0.0
 */
export class SubmissionList extends Array {
  /**
   * Constructs a new <code>SubmissionList</code>.
   * @alias module:model/SubmissionList
   * @class
   * @extends Array
   */
  constructor() {
  ...
  /**
   * Constructs a <code>SubmissionList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SubmissionList} obj Optional instance to populate.
   * @return {module:model/SubmissionList} The populated <code>SubmissionList</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SubmissionList();
      ApiClient.constructFromObject(data, obj, 'SubmissionDetail');
    }
    return obj;
  }
}
