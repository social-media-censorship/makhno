...
/**
 * The SubmissionProposal model module.
 * @module model/SubmissionProposal
 * @version 1.0.0
 */
export class SubmissionProposal {
  /**
   * Constructs a new <code>SubmissionProposal</code>.
   * @alias module:model/SubmissionProposal
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SubmissionProposal</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SubmissionProposal} obj Optional instance to populate.
   * @return {module:model/SubmissionProposal} The populated <code>SubmissionProposal</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SubmissionProposal();
 ...
 * @member {String} url
 */
SubmissionProposal.prototype.url = undefined;

/**
 * @member {Array.<String>} countryCodes
 */
SubmissionProposal.prototype.countryCodes = undefined;
