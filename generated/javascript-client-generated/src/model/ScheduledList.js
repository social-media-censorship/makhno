...
/**
 * The ScheduledList model module.
 * @module model/ScheduledList
 * @version 1.0.0
 */
export class ScheduledList extends Array {
  /**
   * Constructs a new <code>ScheduledList</code>.
   * @alias module:model/ScheduledList
   * @class
   * @extends Array
   */
  constructor() {
  ...
  /**
   * Constructs a <code>ScheduledList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScheduledList} obj Optional instance to populate.
   * @return {module:model/ScheduledList} The populated <code>ScheduledList</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ScheduledList();
      ApiClient.constructFromObject(data, obj, 'ScheduledActivity');
    }
    return obj;
  }
}
